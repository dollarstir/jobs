                ...
                <div class="col-lg-8">
                    <div class="job-details-item">
                        ...
                        <div class="text-center">
                            <a class="job-details-btn" href="extra-data.php">Apply Now</a>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="companies-slider owl-theme owl-carousel">
                                <div class="companies-item">
                                    ...
                                    <h3>
                                        <a href="company-details.php">Winbrans</a>
                                    </h3>
                                    <p>
                    ...
                    <div class="job-details-item">
                        ...
                        <div class="job-overview job-company">
                            ...
                            <ul>
                                <li>
                                    <!-- <i class="icofont-location-pin"></i> -->
                                    <span>Monday 9 AM - 5 PM</span>
                                </li>
                                <li>
                                    <span>Tuesday 9 AM - 5 PM</span>
                                </li>
                                <li>
                                    <span>Wednesday 9 AM - 5 PM</span>
                                </li>
                                <li>
                                    <span>Thursday 9 AM - 5 PM</span>
                                </li>
                                <li>
                                    <span>Friday 9 AM - 5 PM</span>
                                </li>
                            </ul>
                        </div>
                        <div class="job-overview job-company">
