    ...
    <div class="container">
      ...
      <div class="companies-slider owl-theme owl-carousel">
        <div class="companies-item">
          ...
          <h3>
            <a href="browse-by-category-details.php">Winbrans.com</a>
          </h3>
          <p>
        ...
        <div class="companies-item">
          ...
          <h3>
            <a href="browse-by-category-details.php">Infiniza.com</a>
          </h3>
          <p>
            <i class="icofont-location-pin"></i>
        ...
        <div class="companies-item">
          ...
          <h3>
            <a href="browse-by-category-details.php">Glovibo.com</a>
          </h3>
          <p>
            <i class="icofont-location-pin"></i>
            Barming Road, UK
        ...
        <div class="companies-item">
          ...
          <h3>
            <a href="browse-by-category-details.php">Bizotic.com</a>
          </h3>
          <p>
            <i class="icofont-location-pin"></i>
            Washington, New York
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-6">
                        <div class="jobseeker-item">
                            ...
                            <div class="jobseeker-inner">
                                <span>Candidate Browse by Category</span>
                                <h3>SignUp as a Candidate</h3>
                            </div>
                            <a href="candidate-Browse by Category.php">Get Started
                    ...
                    <div class="col-sm-6 col-lg-6">
                        <div class="jobseeker-item">
                            ...
                            <div class="jobseeker-inner">
                                <span>Employer Browse by Category</span>
                                <h3>SignUp as a Employer</h3>
                            </div>
                            <a href="employer-Browse by Category.php">Get Started
                                <i class="icofont-arrow-right"></i>
                            </a>
                        </div>
                    </div>
